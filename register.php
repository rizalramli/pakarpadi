                        ...
                        <div class="col-12">
                            ...
                            if(isset($_POST['register']))
                            {
                                ...
                                if($password == $konfirmasi_password)
                                {
                                    ...
                                    $query_insert = mysqli_query($koneksi, "INSERT INTO admin (Kd_admin,username,password,role) VALUES (NULL,'$username','$password','Customer') ");
                                    if ($query_insert) {
                                ...
                                <div style="padding:30px 350px 200px 350px">
                                    <form action="" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-12">
                                                <div class="form-group">
                                                    <input type="password" name="konfirmasi_password" class="form-control" id="contact-email" placeholder="Konfirmasi Password">
                                                </div>
                                            </div>
                                            <div class="col-12">
